...
const DominoScene = () => {
  ...
  return (
    <div className="relative min-w-screen h-screen bg-gray-900 overflow-hidden perspective-1000">
      {/* Background Layers */}
      <div 
          ...
          <div className="relative w-64 h-64 md:w-96 md:h-96">
            {[...Array(6)].map((_, i) => (
              <div
                ...
                style={{
                  transform: `rotate(${i * 60}deg) translateX(100px) rotateY(${sequence === 2 ? 360 : 0}deg)`,
